    ...
    class EBook : Book
    {
        ...
        public String DeleteRecord()
        {
            ...
            try
            {
                conn.Open();
                int resultInt = comm.ExecuteNonQuery();
                result = $"SUCCESS: Deleted {resultInt} records";
        ...
        public DataSet GetRecordsFromDB(String title, String last)
        {
            ...
            String commStr = "SELECT EBookID, Title, AuthorFirst, AuthorLast, DatePublished FROM EBooks WHERE 0=0";
            ...
            if (last.Length > 0)
            {
                commStr += " AND AuthorLast LIKE @AuthorLast";
        ...
        public SqlDataReader GetRecordsFromDBDR(String title, String last)
        {
            DataSet ds = new DataSet();
